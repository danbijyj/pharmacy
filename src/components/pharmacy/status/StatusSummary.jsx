...
const StatusSummary = ({
    ...
    return (
        <div className="relative mb-12">
            ...
            <div className="inner bg-white rounded-lg shadow-status relative z-10 py-12">
                <div className="text-center mb-12">
                    <h3 className="relative inline-block z-10 text-xl px-1">
                ...
                <ul className="flex items-center justify-between text-center">
                    <li className="flex flex-1 items-center justify-center gap-5">
                    ...
                    <li className="w-px h-8 bg-gray-300" />
                    <li className="flex flex-1 items-center justify-center gap-5">
                        <div className="flex items-center gap-2">
